...
### Ins: Offer Feedback to Students
...
### Ins: Deploying to GitHub Pages - Personal
...
- Start out with a walk through of the first method: creating a personal website using GitHub Pages.
  ...
  2. Next, open up Git Bash or Terminal on your computer. Navigate into the directory that you would like to store your project in and then clone the repository you just created.
  3. Within this new directory, add an HTML file called `index.html` which contains the code for the website you would like to publish.
...
### Stu: Deploying Personal Bios to GitHub Pages
...
### Ins: Deploying to GitHub Pages - Projects
