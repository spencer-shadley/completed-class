...
The deployed assignment utilizes JavaScript to read user's input on the keyboard, and compare it to a randomized letter choice. It notifies the user whether they've won or lost at the end of the game. The deployed assignment has been added to their deployed portfolio with a link provided in the submission.
