...
The deployed assignment utilizes React, React Router, and uses a global Store to manage application state. You should be able to walk through the following steps:

  * Add two items to the shopping cart.

  * View the shopping cart on a separate page.

  * Remove an item from the shopping cart.

The deployed assignment has been added to their deployed portfolio with a link provided in the submission.
