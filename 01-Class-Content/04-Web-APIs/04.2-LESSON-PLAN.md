...
* First a few points
    ...
    * command line, git, GitHub, deploying websites to GitHub Pages, HTML, CSS, JavaScript (3 languages), Bootstrap, flexbox, arrays, control flow with if/else, logging
...
* How do we enable a user to add another user?
  * input for `name`
  * get data from `name` when `Add Person` is pressed
...
[11-Stu_Onclick/Solved/script.js](../../../UW-SEA-FSF-PT-11-2019-U-C/11-Stu_Onclick/Solved/script.js)
