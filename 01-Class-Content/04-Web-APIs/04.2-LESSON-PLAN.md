...
* First a few points
    ...
    * VS Code, command line, git, GitHub, deploying websites to GitHub Pages, HTML, CSS, JavaScript (3 languages), Bootstrap, responsive, handle user input, flexbox, arrays, functions, objects, control flow with if/else, logging
