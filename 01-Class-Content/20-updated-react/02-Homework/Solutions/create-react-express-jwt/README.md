...
Server-side article and using JWT: [here](https://hptechblogs.com/using-json-web-token-for-authentication/)

Front End article on using the JWT on a react application: [here](https://hptechblogs.com/using-json-web-token-react/)
