...
function getPasswordOptions() {
  ...
  // Function is called to generate password, passing user input in as an argument
...
function generatePassword(options) {
  ...
  // Ensure there is at least one of each guaranteed character in the result
  for (var i = 0; i < guaranteedCharacters.length; i++) {
    var character = guaranteedCharacters[i];
...
copyBtn.addEventListener("click", function(e) {
  if (copyBtn.hasAttribute("disabled") === true) {
    return;
  }
