# 3.1 - Joys of JavaScript (6:30 PM)
...
### Instructor Do: How to Learn JavaScript (5 min)
...
### Partners Do: Code Dissection (10 min)
...
### Instructor Do: What is JavaScript (5 min)
...
### Instructor Do: Variables Slides + Demo (5 min)
...
### Students Do: Variable Activity (10 min)
...
### Instructor Do: Review Variable Activity (5 min)
...
- Spend a few moments reviewing the activity `03-PizzaVariables/Solved`. In discussing the solution, explain both the variable assignment and the way strings are combined in the alerts.
  ...
  ### Instructor Demo: Console Log (5 min)
...
### Instructor Do: Console Log Slides (5 min)
...
### Students Do: Console Log Activity (5 min)
...
### Instructor Do: Review Console.log Activity (5 min)
...
### Instructor Demo: Alerts, Prompts, Confirms (5 min)
...
- **Important:** Be sure to point out how `prompt` and `confirm` create data that can be stored in a variable directly.
  ...
  - Explain that `prompt` and `confirm` _return_ whatever the user enters in the text prompt.
    ...
    ### Instructor Do: Alerts, Prompts, Confirms Slides (5 min)
...
### Instructor Do: Review Alert Activity (5 min)

- Go over the previous activity using `prompt-sushi.html` in `07-PromptSushi/Solved`.

### Instructor Demo: If/Else Statement (10 min)
...
### Instructor Slides: If/Else Statement (5 min)

- Proceed through the instructor slides on conditionals.

### Partners Do: If/Else Activity #1 (15 min)
...
### Instructor Do: Review If/Else Activity #1 (10 min)
...
### Everyone Do: If/Else Activity #2 (10 min)
...
- Then run the program to see if your expectation matched how it functioned.
  ...
  ### Instructor Do: Arrays Slides (5 min)
...
### Instructor Do: Array Demo (5 min)
...
### Everyone Do: Class Code Dissection (10 min)
