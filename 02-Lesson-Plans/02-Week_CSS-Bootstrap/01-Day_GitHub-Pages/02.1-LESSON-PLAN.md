...
removed header line### Everyone Do: Check-Up Session (7 min)
...
### Instructor Do: Offer Feedback to Students (5 min)
...
### Instructor Do: Admin Items (5 min)
...
### Instructor Do: Recapping (10 min)
...
### Instructor Do: Double Take (10 min)
...
- Then talk about Google Developer Tools again. Mention that it is incredibly important for developers. Then walk students through a demo of its use when prompted. Be sure to point out how Google Developer Tools can be used to change both:
  ...
  - CSS Elements (show them how to change the box model in particular)
    ...
    ### Students Do: Modify a Website (15 min)
...
### Students Do: Modify Own Websites (10 mins)
...
removed header line### BREAK (15 min)

removed header line### Instructor Do: Multiple CSS/CSS Resets (10 min)
...
removed header line### END

removed header line### Troubleshooting Guide
