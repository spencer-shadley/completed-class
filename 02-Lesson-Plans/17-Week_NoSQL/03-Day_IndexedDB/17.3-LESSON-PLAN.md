...
### Instructor Do: Intro To IndexedDB (10 min)
...
### Instructor Do: Creating an IndexedDB Connection (5 min)
...
### Student Do: Creating an IndexedDB Connection (10 min)
...
### Instructor Do: Review Creating an IndexedDB Connection (5 min)
...
### Instructor Do: Creating Object Stores (5 min)
...
- Next open [18-Ins_Creating_Object_Stores] in your browser and open your Chrome Developer tools and navigate to `Application` then `IndexedDB`.
...
### Instructor Do: Review Creating Object Stores (5 min)
...
### Instructor Do: Defining Object Store Data with Indexes (5 min)
...
### Student Do: Defining Object Store Data with Indexes (10 min)
...
### Instructor Do: Review Defining Object Store Data with Indexes (5 min)
...
### Instructor Do: Adding and Getting Object Store Data (5 min)
...
### Instructor Do: Review Adding and Getting Object Store Data (5 min)
...
### Instructor Do: Updating Data With Cursors (5 min)
...
### Instructor Do: Review Updating Data With Cursors (5 min)
