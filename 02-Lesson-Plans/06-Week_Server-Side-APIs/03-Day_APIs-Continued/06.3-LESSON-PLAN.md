...
- Encourage pair programming. During the group activity, groups will be made up of four students -- with two students serving as the Front-End team and two students serving as the Backend team. In each of these pairs, only one member should be typing, while the other helps catch bugs and offers advice. This works well as students can help one another catch simple errors in real-time.
...
* Clicking any one of the buttons triggers a series of gifs by its author to emerge
