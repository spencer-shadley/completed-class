...
###### Students Do: CustomerObject Parsing (5 min)
...
### Instructor Do: Review CustomerObject Parsing (5 min)
...
### Students Do: Install JSON Formatter (5 min)
...
### Instructor Do: New York Times Scraper Demo (10 min)
...
### Everyone Do: NYT Scraper Review (5 min)
...
### Students Do: API Research Questions (7 min)
...
### Everyone Do: Review API Research Questions (5 min)

- Have students share their answers to these questions.

### Instructor Do: API Definitions (6 min)
...
### Instructor Do: API Experimenting (10 min)
...
### Students Do: API Experimenting (10 min)
...
### Instructor Do: OMDb API Demo (5 min)
...
### Partners Do: OMDb API Exploration (10 min)
...
### Everyone Do: OMDb API URLs (10 min)
...
### Instructor Do: AJAX Query Demo (10 min)
...
### Everyone Do: Logging JSON (5 min)
...
### Students Do: AJAX Query Activity (15 min)
...
### Students Do: AJAX to HTML Activity (15 min)
...
### Instructor Do: Review AJAX to HTML Activity (7 min)
...
### Partners Do: Giphy Documentation (10 min)
...
### Instructor Do: Giphy API Demo (10 min)
...
### Instructor Do: Homework Intro (5 min)
...
### Students Do: Homework Intro (5 min) (Optional)
...
### Instructor Do: API Key Reminder For Next Class (1 min)
