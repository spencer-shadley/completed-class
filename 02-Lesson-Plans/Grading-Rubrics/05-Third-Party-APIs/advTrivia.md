...
User is show 1 question at a time, and can only select 1 answer. The user is told whether it's correct or not after answering, and is then shown the next question. At the end, the user is given a score, and can play again. The deployed assignment has been added to their deployed portfolio with a link provided in the submission.
