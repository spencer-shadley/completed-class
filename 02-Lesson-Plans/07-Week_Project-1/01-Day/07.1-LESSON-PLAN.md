...
- Two in-class demonstrations ask you to use an existing GitHub repository. You can create one on-the-fly or you may want to create one in advance.
...
### Student Do: User Stories and Issues (5 min)
