# 11.1 - Intro to Node Servers (6:30 PM)
...
removed header line## Class Instructions

### Instructor Do: Server-Side Slide Show (0:25)
...
### Instructor Do: My First Server (0:20)
...
### Instructor Do: Review Two Servers App (0:05)
...
removed header line### Break (0:15)

removed header line### Instructor Do: Portfolio Server (0:15)
...
### Students Do: Discuss Portfolio (0:05)
...
### Instructor Do: Serving HTML (0:15)
...
### Students Do: Discuss Serving HTML (0:05)
...
### Instructor Do: Review Students Serve Favorites (0:10)
...
### Instructor Do: Request Methods (0:10)
...
### Instructor Do: Introduce Friend Finder Homework (0:05)
...
removed header line### END MAIN CONTENT

removed header line### BONUS: Student Do: POST Requests (0:20)
...
### BONUS: Review Post Requests (0:10)
