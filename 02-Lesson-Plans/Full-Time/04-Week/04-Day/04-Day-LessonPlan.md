# 4.4 Project 1 - Project Management (10:00 AM)

### Slideshow

* This lesson's slides are available on Google Drive here: [04-4 Git Visualized](https://docs.google.com/presentation/d/1K1ceGxPy2riRg9lP3_S_tYjbKaxsS84QZfCt4481QqQ/edit?usp=sharing)
...
* Welcome students to class and explain that we will be reviewing the GitHub workflow and learning about some project management concepts before we jump back into projects.

### 2. Instructor Do: Recap git/GitHub (5 min)

Briefly explain each of the following steps as you demonstrate them. You can also present the slide deck [04-4 Git Visualized](https://docs.google.com/presentation/d/1K1ceGxPy2riRg9lP3_S_tYjbKaxsS84QZfCt4481QqQ/edit?usp=sharing) as you demonstrate these steps:
...
* Take some time to explain user stories:
  ...
  * "User stories are a tool that developers use to describe what the user wants and why. They help to keep the focus on adding value to the user during the project build and ensure that each feature built is in line with the primary goal of the product."
...
* Remind students that there are lots of nice features that users might like but that are not *essential*:
  ...
  * "While these features would be nice to have, the product could still be demoed and pitched to investors without them. With this project, the MVP should be the *minimum* product that could be pitched to an investor to demo what the project could eventually become. Rather than a minimum *viable* product, we're actually building a minimum *demo-able* product"
...
* Explain the following:
  ...
  * "Acceptance criteria outline what must be accomplished before the issue is closed. Acceptance criteria tell both the developer and the reviewer what is expected for this feature."
...
* *BAD TASK*: 
1. On new member form submit, find and display the best match.
...
* Walk the students through board:
  ...
  * "Each unit should have a set focus - this unit that focus is completing the MVP."

  * "Every task that is vital to completing the unit's goal should go in the 'To Do' column."
...
* Explain the stand-up format.
  ...
  * "We hold standups daily so teammates can hold each other accountable, but also so they can help each other if they get stuck."
