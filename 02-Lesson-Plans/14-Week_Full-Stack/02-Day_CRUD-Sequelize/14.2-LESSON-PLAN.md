# 14.2 - Getting In The CRUD with Sequelize (6:30 PM)
...
removed header line### Instructor Do: Pulse Check and Sequelize Review
...
removed header line### Instructor Do: TodoList Demo (10 mins)
...
removed header line### Warm Up: Connect to Sequelize and Create a Todo Model (30 mins)
...
removed header line### Instructor Do: Review the ORM-To-Sequelize Activity (10 mins)
...
removed header line### Partners Do: findAll and create (15 mins)
...
removed header line### Everyone Do: Review findAll and create (10 mins)
...
removed header line### Instructor Demo: Update and Delete (5 mins)
...
removed header line### Partners Do: Update and Delete (20 mins)
...
removed header line### Everyone Do: Review Update and Delete (15 mins)
...
removed header line### Instructor Do: Validations (5 mins)
...
removed header line### Everyone Do: Discuss With Partners (10 mins)
...
removed header line### Partners Do: Sequelize Validations (15 mins)
...
removed header line### Instructor: Review Validations and Dismiss Class (10 mins)
