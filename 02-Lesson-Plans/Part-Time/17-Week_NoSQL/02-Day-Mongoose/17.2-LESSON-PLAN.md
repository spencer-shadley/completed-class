# 17.2 Lesson Plan - Intro To Mongoose (6:30 PM) <!--links--> &nbsp; [⬅️](../01-Day/01-Day-LessonPlan.md) &nbsp; [➡️](../03-Day/03-Day-LessonPlan.md)
...
* Complete activities `9-17` in `17-NoSQL`
...
### 1. Instructor Do: Demo MongoJS Warmup (5 mins)
...
### 2. Student Do: MongoJS Warm Up (10 mins)
...
### 3. Instructor Do: Review MongoJS Warmup (5 mins)
  
* Open [08-Stu-Mongojs-Review/Solved/server.js](../../../../01-Class-Content/17-noSQL/01-Activities/09-Stu-Mongojs-Review/Solved/server.js) and scroll down to the routes.
...
### 5. Instructor Do: Demo Solved Mongoose Schema (5 mins)
...
### 6. Student Do: Mongoose Schema (10 mins)
...
### 7. Instructor Do: Review Mongoose Schema (5 mins)
...
### 9. Instructor Do: Custom Methods (10 mins)
...
* Open up [14-Populate/Solved/server.js](../../../../01-Class-Content/17-noSQL/01-Activities/15-Stu-Populate/Solved/server.js).
