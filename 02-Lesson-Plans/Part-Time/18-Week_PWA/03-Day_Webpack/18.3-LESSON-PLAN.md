...
* Complete activities `17-Ins_Webpack-Intro` through `25-Stu-Mini-Project`
...
* Navigate to [17-Ins-Webpack-Intro](../../../../01-Class-Content/18-PWA/01-Activities/17-Ins-Webpack-Intro) from the command line and run:

  * `npm install webpack webpack-cli -D`

* Open [webpack.config.js](../../../../01-Class-Content/18-PWA/01-Activities/17-Ins-Webpack-Intro/webpack.config.js) in your IDE and point out the following:
...
* Open [package.json](../../../../01-Class-Content/18-PWA/01-Activities/17-Ins-Webpack-Intro/package.json) in your IDE and point out the following:
...
* Open the file [src/app.js](../../../../01-Class-Content/18-PWA/01-Activities/17-Ins-Webpack-Intro/src/app.js) in your IDE.
...
* Direct students to the activity instructions found in [18-Stu-Webpack-Intro](../../../../01-Class-Content/18-PWA/01-Activities/18-Stu-Webpack-Intro)
...
* Open [src/app.js](../../../../01-Class-Content/18-PWA/01-Activities/18-Stu-Webpack-Intro/Solved/src/app.js) in the browser and demonstrate the following functionality:
...
* Open [src/app.js](../../../../01-Class-Content/18-PWA/01-Activities/18-Stu-Webpack-Intro/Solved/src/app.js) in your IDE and point out the following:
...
* Open [webpack.config.js](../../../../01-Class-Content/18-PWA/01-Activities/18-Stu-Webpack-Intro/Solved/webpack.config.js) in your IDE and point out the following:

  * We use the same configuration as the previous demo.

* Open [package.json](../../../../01-Class-Content/18-PWA/01-Activities/18-Stu-Webpack-Intro/Solved/package.json) in your IDE and point out the following:
...
* Open [package.json](../../../../01-Class-Content/18-PWA/01-Activities/19-Ins-First-Plugin/package.json) in your IDE and explain the following: 
...
* Open [webpack.config.js](../../../../01-Class-Content/18-PWA/01-Activities/19-Ins-First-Plugin/webpack.config.js) in your IDE and point out the following:
...
* Direct students to the activity instructions found in [24-Stu-Webpack-Plugin](../../../../01-Class-Content/18-PWA/01-Activities/20-Stu-Webpack-Plugin)
...
* Open [webpack.config.js](../../../../01-Class-Content/18-PWA/01-Activities/20-Stu-Webpack-Plugin/Solved/webpack.config.js) in your IDE and point out the following:
...
* Open [package.json](../../../../01-Class-Content/18-PWA/01-Activities/20-Stu-Webpack-Plugin/Solved/package.json) in your IDE and point out the following:
...
* Open [21-Ins-Pure-Functions/webpack.config.js](../../../../01-Class-Content/18-PWA/01-Activities/21-Ins-Pure-Functions/webpack.config.js) in your IDE and point out the following:
...
* Open up [src/app.js](../../../../01-Class-Content/18-PWA/01-Activities/21-Ins-Pure-Functions/src/app.js) and point out the reorganization of the files. 
...
* Open [src/calculations.js](../../../../01-Class-Content/18-PWA/01-Activities/21-Ins-Pure-Functions/src/calculations.js) in your IDE and point out the following:
...
* Open [src/app.js](../../../../01-Class-Content/18-PWA/01-Activities/21-Ins-Pure-Functions/src/app.js) in your IDE and point out the following:
...
* Run `npm install` from the command line, open [index.html](../../../../01-Class-Content/18-PWA/01-Activities/21-Ins-Pure-Functions/index.html) file in your browser and demonstrate the following functionality:
...
* Direct students to the activity instructions found in [24-Stu-Refactor](../../../../01-Class-Content/18-PWA/01-Activities/22-Stu-PWA-Refactor)
...
### 10. Instructor Do: Review Pure Functions (10 mins)

* Open [22-Stu-PWA-Refactor/Solved/public/assets/js/app.js](../../../../01-Class-Content/18-PWA/01-Activities/24-Stu-Refactor/Solved/public/assets/js/app.js) in your IDE and explain the following:

  * We are using ES6 syntax to import `createCards` from `cardCreation`.

  * This is the file that is responsible for running `loadImages` and creating cards from the data. We export `loadImages` so that other files can have access to the function.
...
* Open [cardCreation.js](../../../../01-Class-Content/18-PWA/01-Activities/24-Stu-Refactor/Solved/public/assets/js/cardCreation.js) in your IDE and explain the following:

  * All functions related to creating cards are now in their own file. 

  * 🎗Remember, the purpose of refactoring our code was to **separate concerns** and make our code more intuitive and easier to work with.
...
* Open [domMethods.js](../../../../01-Class-Content/18-PWA/01-Activities/24-Stu-Refactor/Solved/public/assets/js/domMethods.js) in your IDE and explain the following:

  * Our `createEl` function serves as a utility that has no dependencies. We separate it out into its own file so that it's easier to locate and import from other files.
...
* Open [service-worker.js](../../../../01-Class-Content/18-PWA/01-Activities/24-Stu-Refactor/Solved/public/service-worker.js) in your IDE and explain the following:

  * Point out that the only thing we need to change in `service-worker.js` is the files that are cached.

  ```js
  "/dist/bundle.js",
  ```

* 📝 Before moving on to the next activity, spend a few minutes to make sure that students understand why the code has been separated into multiple files. We try to keep functions that are heavily dependant on each other in their own files.
...
* Open [23-Ins-Chunking/webpack.config.js](../../../../01-Class-Content/18-PWA/01-Activities/23-Ins-Chunking/webpack.config.js) in your IDE and point out the following:
...
* Open [chart.html](../../../../01-Class-Content/18-PWA/01-Activities/23-Ins-Chunking/chart.html) and point out the following:
...
* `cd` into [23-Ins-Chunking](../../../../01-Class-Content/18-PWA/01-Activities/23-Ins-Chunking) and run the following commands from your command line:
...
### 12. Student Do: Lazy Loading JavaScript (15 mins)

* Direct students to the activity instructions found in [24-Stu-Chunking](../../../../01-Class-Content/18-PWA/01-Activities/24-Stu-Chunking)
...
* Open [24-Stu-Chunking/Solved/webpack.config.js](../../../../01-Class-Content/18-PWA/01-Activities/24-Stu-Chunking/Solved/webpack.config.js) in your IDE and explain the following:
...
* In a separate tab, run the following commands from the command line:

  * `npm install`

  * `npm start`

* Navigate to [localhost](<https://localhost:3000>) in your browser and explain the following:
...
* Open [25-Stu-Mini-Project/Solved/client/assets/js/index.js](../../../../01-Class-Content/18-PWA/01-Activities/25-Stu-Mini-Project/Solved/client/assets/js/index.js) in your IDE and point out the following:

  * All of the functions pertaining to the `home` page are in `index.js`.

  * `createElement` is brought in from the `domMethods.js` file.

* Open [25-Stu-Mini-Project/Solved/client/assets/js/domMethods.js](../../../../01-Class-Content/18-PWA/01-Activities/25-Stu-Mini-Project/Solved/client/assets/js/domMethods.js) in your IDE and point out the following:
...
* Open [topic.js](../../../../01-Class-Content/18-PWA/01-Activities/25-Stu-Mini-Project/Solved/client/assets/js/topic.js) in your IDE and explain the following:
...
* Open [service-worker.js](../../../../01-Class-Content/18-PWA/01-Activities/25-Stu-Mini-Project/Solved/client/service-worker.js) in your IDE and point out the following:
...
* Open [webpack.config.js](../../../../01-Class-Content/18-PWA/01-Activities/25-Stu-Mini-Project/Solved/client/webpack.config.js) in your IDE and point out the following:
