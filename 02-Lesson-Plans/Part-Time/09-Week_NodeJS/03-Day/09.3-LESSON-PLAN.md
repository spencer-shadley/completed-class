...
* Ask the class the following question(s) and call on students for the corresponding answer(s):
  ...
  * ☝️So how is `fs.readFile` asynchronous?
  ...
  * ☝️How can we be sure if a function is running synchronously or asynchronously?
