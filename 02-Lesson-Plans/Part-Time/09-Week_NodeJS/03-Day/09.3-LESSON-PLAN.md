...
* Point out the following key point(s):
  ...
  *  🔑 In order to get just the repo names and not all of the JSON data, we're using the `map` method to return the repo names into the `repoNames` array.
...
* We've been using Promises for a while now -- since learning jQuery -- without really talking about them.
...
* Use the prompts and talking points below to demonstrate the following key point(s):
  ...
  * ✔️ We can construct and HTML string using string template literals
...
* Open [40-Stu_Mini-Project/Solved/Bonus/index.js](../../../../../../../../../../../../01-Class-Content/09-NodeJS/01-Activities/40-Stu_Mini-Project/Solved/Bonus/index.js)
  ...
  * 🔑 We're using a `try/catch` block to handle any errors than may occur when using async/await.
