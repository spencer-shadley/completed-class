...
* Open [13-Ins_Introduce-Mocks/index.js](../../../../01-Class-Content/10-oop/01-Activities/13-Ins_Introduce-Mocks/index.js) file in your editor and point out the following key points:
  ...
  * This file imports a `Logger` constructor that creates an object capable of logging to the console in different colors. Run the example in your terminal to demonstrate this, and point out the logs themselves, explaining on a high-level how this is achieved.

* Open [13-Ins_Introduce-Mocks/logger.js](../../../../01-Class-Content/10-oop/01-Activities/13-Ins_Introduce-Mocks/logger.js) file in your editor and point out the following key points:
  ...
  * At first glance the code in this file may look a little unusual, but it's actually pretty simple.
...
* Open [13-Ins_Introduce-Mocks/test/logger.test.js](../../../../01-Class-Content/10-oop/01-Activities/13-Ins_Introduce-Mocks/test/logger.test.js) file in your editor and point out the following key points:
...
* Run the test in your terminal with `npm run test` and demonstrate the console output.

* Answer any lingering questions before moving on to the next activity.

### 14. Students Do: First Mock (15 mins)
...
### 15. Instructor Do: Review First Mock (10 mins)
...
* Open [13-Ins_Introduce-Mocks/test/14-Stu_First-Mock/Solved/test/dayCare.test.js](../../../../01-Class-Content/10-oop/01-Activities/14-Stu_First-Mock/Solved/test/dayCare.test.js) file in your editor and point out a few of the mock examples:
  ...
  * 🔑 By mocking `console.log`, we can prevent it from running and filling up our terminals when running tests.

  * 🔑 We're able to spy on the `console.log` method and verify that it was called with the arguments we expect.
...
### 16. Instructor Do: Module Mock Demo (5 mins)

* Use the prompts and talking points below to review the following key point(s):

  * ✔️ There are a few extra steps required to mock third party and built-in node modules, but the idea is the same.

* Open [15-Ins_Module-Mock-Demo/movieSearch.js](../../../../01-Class-Content/10-oop/01-Activities/15-Ins_Module-Mock-Demo/movieSearch.js) file in your editor and point out the following key points:
...
* Open [15-Ins_Module-Mock-Demo/test/movieSearch.test.js](../../../../01-Class-Content/10-oop/01-Activities/15-Ins_Module-Mock-Demo/test/movieSearch.test.js) file in your editor and point out the following key points:
  ...
  * 🔑 At the top of the file we require axios and mock it, since we want to prevent actual AJAX requests from happening. This is one way of mocking a node module.
  ...
  * 🔑 Below, mock the return value of `axios.get` to be a new Promise object that resolves to an object that contains a `data` property that's set to an empty object. We're mocking the return value to this because it's similar to what we would get from the response from the OMDB API.
...
### 17. Students Do: Mock FS (10 mins)
...
### 18. Instructor Do: Review Mock FS (10 mins)
