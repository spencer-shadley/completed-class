# 09.1 Lesson Plan: Introduction to Node.js (6:30 PM) <!--links--> &nbsp; [⬅️](../../08-Week/03-Day/08.3-LESSON-PLAN.md) &nbsp; [➡️](../02-Day/09.2-LESSON-PLAN.md)
...
* Instruct students to press `ctrl+c` or `cmd+c` to exit the Node prompt. (Important as many students will not do this.)
...
* Direct students to the activity instructions in [02-Stu_Hello-Node](@TODO):
...
* Use the prompts and talking points below to review the following key point(s):
  ...
  * ✔️ `global` is a reference to the module invoking it

* Open [02-Stu_Hello-Node/Solved/index.js](@TODO) in your IDE and explain the following point(s):
...
* Ask the class the following question(s):
  ...
  * ☝️ Did anyone experiment with anything _beyond_ `conosole.log`? If so, what?
  ...
  * 🙋 `global` refers to _this_ module, which is why the return of `this` is the same. 
...
* Run `node index.js` and point out the following: 
  ...
  * 🔑 `global` in Node.js is similar to `window` in the browser. Unlike `window`, we can see that there are fewer properties and methods available to us, which makes sense as many of those pertain directly to browser functionality.
...
* Run [03-Ins_process.argv/index.js](@TODO) from the command line with `node`. The results will be similar to the following:
...
* Open [03-Ins_process.argv/index.js](@TODO) in your IDE and explain the following point(s):
...
* Direct students to the activity instructions in [03-Stu_Parameter-Check](@TODO):
...
* Navigate to [04-Stu_Parameter-Check/Solved](@TODO) and run the following commands to demonstrate functionality of the application:

  * `node index.js 3 4`

  * `node index.js 7 7`

* Open [04-Stu_Parameter-Check/Solved/index.js](@TODO) and explain the following:  
...
* Open [05-Ins_readFile/index.js](@TODO) and explain the following points:
...
* Run [05-Ins_readFile](@TODO) from the command line and run `node index.js`. The results will be similar to:
...
* Open [06-Ins_writeFile](@TODO) in your IDE and explain the following:
...
* Direct students to the activity instructions found in [07-Stu_appendFile](@TODO).
...
* Run [07-Stu_appendFile/index.js](@TODO) from the command line to demonstrate the application functionality, entering commands similar to the following:
...
* Open [07-Stu_appendFile/index.js](@TODO) and explain the following:
...
* Run [08-Ins_Modularization/index.js](@TODO) from the command line. The output will be the following: 
...
* Open [08-Ins_Modularization/index.js](@TODO) in your IDE and explain the following: 
...
* Open [08-Ins_Modularization/badmath.js](@TODO) and explain the following: 
...
* Direct students to the activity instructions found in [09-Stu_maths-Module](@TODO)
...
* Run [09-Stu_maths-Module/Solved/index.js](@TODO) from the command line to demonstrate the application functionality, entering commands similar to the following:
...
* Open [09-Stu_maths-Module/Solved/maths.js](@TODO) and explain the following: 
...
* Run [10-Ins_npm/index.js](@TODO) from the command line and point out the following: 
...
* Open the [10-Ins_npm](@TODO) directory and point out the following: 
...
* Direct students to the activity instructions in [11-Stu_package.json](@TODO).
...
* Open [15-Stu_Inquirer-Users]() in your IDE and explain the following: 
