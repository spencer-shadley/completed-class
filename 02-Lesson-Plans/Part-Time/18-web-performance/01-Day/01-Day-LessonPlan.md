...
* Ask students what they think makes a web application performant.
...
* Let students know that on the web we can use something called GZip compression via an NPM Package called `compression`.
  ...
  * This middleware will enable compresion for our project, allowing for compressed versions of our files to be sent over the network for faster download times.
...
* Navigate to [compression npm](https://www.npmjs.com/package/compression)
  ...
  * Read about what the package does.

* Use the docs to enable compression in your application.

* Once completed, navigate to your page and look at the traffic via the Network tab.

  * Once in your `Network` tab, you should be able to see the sizes of the files your page is requesting.

  * Note down the Larger/Smaller file size numbers.
...
* Ask students if they have any lingering questions.

* Let the students know they've done a great job so far, and let them go for their break.
