...
* Ask the class the following question(s): 
  ...
  * ☝️ What is IndexedDB and why should we use it?

  * 🙋 From the name, IndexedDB, we can guess that it is a database (DB) accessed by Index in the client! Like MongoDB, it is object-oriented, meaning we can store anything in it! Large amounts of data, offline experience and improved performance.
