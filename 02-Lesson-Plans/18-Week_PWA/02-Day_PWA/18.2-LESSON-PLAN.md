# 18.2 - Progressive Web Applications (6:30 PM)
...
### Instructor Do: Progressive Web Apps (10 min)
...
### Student Do: Progressive Web Applications (15 min)
...
### Instructor Do: Web App Manifest Demo (5 min)
...
### Student Do: Web App Manifest (15 min)
...
### Instructor Do: Review Web App Manifest (10 min)
...
### Instructor Do: Intro To Service Workers (5 min)
...
### Student Do: Register Service Worker (15 min)
...
- Open your Chrome Dev Tools and navigate to Application then your Service Worker tab. Check to see if your service worker file was successfully found. You should see two messages, one from the `service-worker.js` file and one from the script tag that you put in your `index.html` file.
  ...
  ### Instructor Do: Review Register Service Worker (15 min)
...
### Instructor Do: Creating An Offline Experience (5 min)
...
### Student Do: Caching Files (10 min)
...
### Instructor Do: Review Caching Files (5 min)
...
### Instructor Do: Demo Notetaker PWA (5 min)
...
### Instructor Do: Review Notetaker PWA (15 min)
