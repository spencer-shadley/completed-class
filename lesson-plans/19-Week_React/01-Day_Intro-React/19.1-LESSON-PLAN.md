...
- routes directory
  ...
  - add many transactions (offline queue)

  - get transactions

  - given db.js which references this

- html and assets are handled with express.static
...
- public directory
  ...
  - index.js
    ...
    - on click make post requests

  - db.js handles interacting with indexeddb or server
