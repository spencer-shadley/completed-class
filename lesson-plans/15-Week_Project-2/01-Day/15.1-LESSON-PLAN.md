...
### Instructor Do: Linting Slides + Overview
...
### Instructor Do: Review No Lint Example
...
### Instructor Do: Review Eslint Example
...
- Suggest that students use at least the basic eslint config provided for them in their projects.  ### Instructor Do: Introduce Travis CI Slides
