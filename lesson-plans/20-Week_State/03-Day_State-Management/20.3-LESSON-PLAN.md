# 20.3 - State Management with the Store (10:00 AM)
...
- Ask the students the following questions:
  ...
  - How might we manage state when if there are several different objects to keep track of, and several components that have the ability to update them?
...
- Run [16-Ins_useReducer] by copying the `src` directory into your prepared CRA application. Navigate to http://localhost:3000/ in your browser and demonstrate the following:
...
- Run [useReducer/Solved] by copying the `src` directory into your prepared CRA application. Navigate to http://localhost:3000/ in your browser and demonstrate the following:
...
- Run [Ins_Store] by copying the `src` directory into your prepared CRA application. Navigate to http://localhost:3000/ in your browser and demonstrate the following:
...
- Run [Store Solved] by copying the `src` directory into your prepared CRA application. Navigate to http://localhost:3000/ in your browser and demonstrate the following:
