...
- Run `08-Ins_useState` by copying the `src` directory into your prepared CRA application. Navigate to http://localhost:3000/ in your browser and demonstrate the following:
...
- Run [09-Stu_useState/Solved] by copying the `src` directory into your prepared CRA application. Navigate to http://localhost:3000/ in your browser and demonstrate the following:
...
- Run [11-Stu_useEffect/Solved/] by copying the `src` directory into your prepared CRA application. Navigate to http://localhost:3000/ in your browser and demonstrate the following:
