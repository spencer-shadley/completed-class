...
- Ask the class, "What is a zip file?"
  ...
  - A `.zip` file is a compressed version of a normal folder. When you `unzip` it, the directory contains all of the information it had before it was zipped.
