...
### Stu: Create a Superpower Captain Planet
...
* Then, slack out the below directory and instructions.
...
* Next, open the files found in the directory `12-CrystalExample`. These files closely match the students' homework assignment.
