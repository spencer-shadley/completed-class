# 5.3 - jQuery Calculator (10:00 AM)
...
### Ins: Motivation + Pulse Check (10 min) (High)
...
### Partners: This Example (10 min) (High)
...
- If you finish early, begin pondering the bonus item. This is a **very** challenging exercise. It's impossible to complete in the allotted time. If you're feeling valiant - complete it outside of class and come back to instructors/TAs to go over it. This will arm you for difficult interview questions in the future.
...
### Ins: Intro Calculator + Group Formation (10 min) (High)
