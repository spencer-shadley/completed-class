...
### Instructor Do: Creating a Database Connection Demo (5 min)
...
- Run the code in your terminal and show the result to the class, asking for any questions regarding this process before slacking out the following assignment.
  ...
  ### Students Do: Creating a Database Connection (10 min)
...
### Instructor Do: Reading Data From a Database (10 min)
...
### Students Do: Collecting Data From a Database (15 min)
...
### Everyone Do: Collecting Data From a Database (10 min)
...
### Instructor Do: Creating, Updating, and Deleting Data Using Node (15 min)
...
### Students Do: CRUD Playlist (20 min)
...
### Everyone Do: Share Your Work (20 min)
