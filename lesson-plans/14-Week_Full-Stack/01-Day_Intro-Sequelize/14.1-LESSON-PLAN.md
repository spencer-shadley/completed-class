...
- TODO: replace this with a better diagram

- MVC concepts

- ask: which components belong to the model, view and controller
...
* Slack out the `01-Chirpy-mySQL` directory and the following instructions:
...
### Ins: Introduce Sequelize Before a Quiz
...
### Ins: Intro to Sequelize CLI (15 -20 min)
