...
### Instructor Do: How to Learn JavaScript
...
### Instructor Do: What is JavaScript
...
### Instructor Do: Variables Slides + Demo
...
### Instructor Do: Review Variable Activity
...
### Instructor Do: Console Log Slides
...
### Students Do: Console Log Activity
...
### Instructor Do: Review Console.log Activity
...
- **Important:** Be sure to point out how `prompt` and `confirm` create data that can be stored in a variable directly.
  ...
  - Explain that `prompt` and `confirm` _return_ whatever the user enters in the text prompt.
    ...
    ### Instructor Do: Alerts, Prompts, Confirms Slides
...
### Instructor Do: Review Alert Activity
...
### Instructor Do: Review If/Else Activity #1
