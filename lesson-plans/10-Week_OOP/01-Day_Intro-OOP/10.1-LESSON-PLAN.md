...
### Students Do: Raining Cats and Dogs (15 min)
...
### Instructor Do: Review Raining Cats and Dogs

- (5 min)

   - Keys can have the value of a function

  - Dot notation can be used to modify objects and call methods.
...
- (10 min)
  ...
  - ✔️The `new` keyword invokes is used to create new objects.
   ...
   - What difference do you from the previous activity we worked on?

  - We create a constructor function called `Animals`, instead of individual cat and dog objects.

  - Why is `Animal` upper-cased. ️
...
### Instructor Do: Review Mini-Bank

- (10 min)

   - `MiniBank` is made via creating a constructor function.

  - We use `typeof` to make sure we get the inputs we want.
...
- Open [03-Stu_Mini-Bank/Solved] in your IDE and explain the following points to students:
  ...
  ```
   ...
   - How does OOP make solving this activity easier?
...
### Student Do: Weather Admin (15 min)
...
### Instructor Do: Review Weather Admin
...
### Instructor Do: Introduce Prototypes (15 min)
...
### Student Do: RPG Prototype (20 min)
...
### Instructor Do: Review Tamagotchi
