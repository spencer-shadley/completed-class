# 21.2 Lesson Plan - Introduction to ASP.NET Core MVC

### Overview

Today's lesson will introduce students to the fundamentals of building web applications with ASP.NET Core MVC (MVC).
...
### 1. Instructor Do: MVC Review & Intro to ASP.NET Core MVC  (0:10)
...
* Explain that, in practice, enforcing this **separation of concerns** manually can be difficult.
  ...
  * Many frameworks, such as ASP.NET Core MVC, _force_ you to separate concerns this way, and provide tools for doing so.
...
* Take a moment to address student questions before dismissing class.
