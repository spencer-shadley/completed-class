...
* Know how to use a standup to stay in-sync with their groups and identify blockers early on so they can be removed.

* Be able to use a Kanban board in their group projects.

* Understand the value of a demo-driven playback in keeping stories focused on deliverable features.

* Understand the importance of retrospective meetings to make sure they identify where things may have gone wrong in a sprint and how to be more productive during their next sprint.
...
[06-Stu_Kanban](../../../../01-Class-Content/16-project-2/01-Activities/06-Stu_Kanban/README.md)
