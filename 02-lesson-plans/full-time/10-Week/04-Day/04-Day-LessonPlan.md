...
* This lesson has 2 sets of slides:

  * The first set is available on Google Drive here: [10-4 MERN](https://docs.google.com/presentation/d/1z4s5m5rZt_xVjiRm8qyL_y3UpdFSLGxMbFODvD_J-Xw/edit?usp=sharing)

  * The second set is available on Google Drive here: [10-4 Final Projects](https://docs.google.com/presentation/d/1xMJoFP13BNEQc1UYDCv03BKLW6TJMxOty98RpljoHmI/edit?usp=sharing)

* To add slides to the student-facing repository, download the slides as a PDF by navigating to File > "Download as" and choose "PDF document." Add the slide PDF file to your class repository along with other necessary files.

* **Note:** Editing access is not available for these documents. If you wish to modify the slides, please create a copy by navigating to File > "Make a copy...".
...
* Welcome your students back to Unit 2 of React!
...
* Open the slide deck [10-4 MERN](https://docs.google.com/presentation/d/1z4s5m5rZt_xVjiRm8qyL_y3UpdFSLGxMbFODvD_J-Xw/edit?usp=sharing). Review React and introduce the MERN stack.
...
* Open up the [solution](../../../../01-Class-Content/20-react/01-Activities/10-Stu_AJAXFormDelete/README.md) to the previous activity and go over the new code as a class. The only changes that needed to be made are in the `client/src/pages/Books.js` file.
...
* Announce: no homework for the rest of the course! Well, except for:
  ...
  * This unit's homework (they still gotta hand that one in).
...
### 16. Instructor Do: Final Project Slides - The Deets (7 mins)

* Go over the slide deck [10-4 Final Projects](https://docs.google.com/presentation/d/1xMJoFP13BNEQc1UYDCv03BKLW6TJMxOty98RpljoHmI/edit?usp=sharing).

* Tell students that they should challenge themselves, and that you'll take no excuses. They've made it this far already &mdash; it's time for them to take everything they learned and produce their best work yet.
