...
* Navigate to this URL: [Yoda Translator](https://rapidapi.com/orthosie/api/yoda-translator). Explain to students that the Yoda API will take a string sentence and then output a revised sentence.
