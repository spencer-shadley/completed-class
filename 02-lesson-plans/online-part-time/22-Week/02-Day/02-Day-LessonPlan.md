## 22.2 Lesson Plan - Sorting Algorithms (6:30 PM) <!--links--> &nbsp; [⬅️](../01-Day/01-Day-LessonPlan.md) &nbsp; [➡️](../03-Day/03-Day-LessonPlan.md)
...
### 5. Groups Do: Implement Selection Sort (20 min)
...
* Then, have students think about and try to explain why it's so inefficient.
...
* After a few minutes, call on a student to explain the inefficiency.
  ...
  * If they have trouble articulating their thoughts, call on additional students.
...
### 9. Groups Do: Implement Insertion Sort (15 min)
...
### 12. Instructor Do: Quick-Sort (14 min)
...
### 13. Instructor Do: Which is Best? (13 min)
...
### 15. Groups Do: Pseudocode Quick-Sort (18 min)
...
* Ask a student to explain the recursion.
