## 13.3 Lesson Plan - Express Mini-Project (10:00 AM) <!--links--> &nbsp; [⬅️](../02-Day/02-Day-LessonPlan.md)
...
* Feel free to open up the `phases.md` file found in `15-HotRestaurant` folder and slack it out.
