## 12.2 Lesson Plan - Node Gets a SQL (6:30 PM) <!--links--> &nbsp; [⬅️](../01-Day/01-Day-LessonPlan.md) &nbsp; [➡️](../03-Day/03-Day-LessonPlan.md)
...
### 8. Groups Do: CRUD Playlist (20 mins)
...
* When everyone is back from break, slack out the following instructions...
