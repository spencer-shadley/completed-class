## 19.3 Lesson Plan - Props, Lists, and Stateful Components (10:00 AM) <!--links--> &nbsp; [⬅️](../02-Day/02-Day-LessonPlan.md)

### Slideshow

* This lesson's slides are available on Google Drive here: [19-3 Props, Lists, and Stateful Components](https://docs.google.com/presentation/d/19SsC7LwFCAlubrq7kZt5yVysvnYYodjUYjOiTV0oL0Q/edit?usp=sharing)
...
* Open the slide deck [19-3 Props, Lists, and Stateful Components](https://docs.google.com/presentation/d/19SsC7LwFCAlubrq7kZt5yVysvnYYodjUYjOiTV0oL0Q/edit?usp=sharing).
...
### 3. Groups Do: Calculator Props (10 mins)

* In this activity students will work in breakout groups to write a component that accepts props, performs arithmetic and renders the result.
...
### 5. Groups Do: Props Review (15 mins) (Critical)

* Slack out `25-Stu_PropsReview/Unsolved`

* In this activity students will work in breakout groups to make an existing React application more DRY through the use of reusable components and props.

* **Instructions:** [README.md](../../../../01-Class-Content/19-react/01-Activities/25-Stu_PropsReview/README.md)

* Instructional staff should be bouncing between breakout rooms to assist students during this activity.
...
* Instructional staff should be flipping through shared screens and keeping an eye on slack for questions.
...
### 10. Groups Do: Decrement Counter (10 mins)
...
### 13. Groups Do: Friend Refactor (20 mins) (Critical)
